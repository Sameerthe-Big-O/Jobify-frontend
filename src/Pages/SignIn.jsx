...
function SignIn() {
  ...
  return (
    ...
    // </div>
    <>
      <div className="min-w-screen min-h-screen bg-gray-900  flex items-center justify-center px-5 py-5 5sm:px-10 5sm:py-10">
        <div className="bg-gray-100 lg:container mx-auto text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden">
          <div className="md:flex md:flex-row  flex-col w-full">
            <div className="hidden 5sm:block md:w-1/2 bg-blue-500 py-10 px-10">
              <svg
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
              <div className="text-center mb-10">
                ...
                <div className="flex flex-col justify-center items-cener ">
                  <div className=" 4sm:text-xl xs:text-2xl">Create Account</div>
                  <div className="text-gray-400 4sm:text-base xs:text-xs">
                    Don't have account ?{" "}

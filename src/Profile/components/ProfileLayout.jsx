  ...
  return (
    <div className="bg-gray-100 font-family-karla flex lg:container mx-auto">
      ...
      <aside className="relative bg-transparent h-[100vh] w-64 hidden 6sm:block shadow-xl">
        ...
        <nav class=" flex flex-col justify-between    bg-gray-100 text-black text-xl  font-semibold pt-3">
          ...
          {/* <Link to={}  class="flex items-center  opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
            Blank Page
          </Link>
          <Link to={}  class="flex items-center  opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
            Tables

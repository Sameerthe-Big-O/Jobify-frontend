  ...
  return (
    ...
    <form>
        <div className="grid grid-cols-1 gap-6 mt-4 md:grid-cols-2">
            <div>
                <label className="text-black dark:text-gray-200" for="username">Username</label>
            ...
            <div>
                <label className="text-black dark:text-gray-200" for="emailAddress">Email Address</label>
            ...
            <div>
                <label className="text-black dark:text-gray-200" for="password">Password</label>
            ...
            <div>
                <label className="text-black dark:text-gray-200" for="passwordConfirmation">Password Confirmation</label>
            ...
            <div>
                <label  ame="text-black dark:text-gray-200" for="passwordConfirmation">Color</label>
            ...
            <div>
                <label className="text-black dark:text-gray-200" for="passwordConfirmation">Date</label>
            ...
            <div>
                <label className="text-black dark:text-gray-200" for="passwordConfirmation">Text Area</label>

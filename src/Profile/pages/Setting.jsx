  ...
  return (
    ...
    <form>
        <div class="grid grid-cols-1 gap-6 mt-4 md:grid-cols-2">
            ...
            <div>
                <label class="text-black dark:text-gray-200" for="passwordConfirmation">Color</label>
            ...
            <div>
                <label class="text-black dark:text-gray-200" for="passwordConfirmation">Range</label>
